...
Wir verwenden auf unserer Website Plausible Analytics, ein datenschutzfreundliches Analysetool. Plausible arbeitet vollständig ohne Cookies und erhebt keine personenbezogenen Daten. Stattdessen werden ausschließlich aggregierte Statistiken erstellt, die keine Rückschlüsse auf einzelne Besucher zulassen. Ihre IP-Adresse wird nicht gespeichert, und es werden keine persönlichen Daten an Dritte weitergegeben.

Die Nutzung von Plausible Analytics erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse liegt in der Analyse und Optimierung unserer Website, um unseren Nutzern ein besseres Erlebnis zu bieten.
