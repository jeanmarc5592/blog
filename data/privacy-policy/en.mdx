...
We use Plausible Analytics on our website, a privacy-friendly analytics tool. Plausible operates entirely without cookies and does not collect any personal data. Instead, it generates aggregated statistics that do not allow any conclusions about individual visitors. Your IP address is not stored, and no personal data is shared with third parties.

The use of Plausible Analytics is based on Article 6(1)(f) of the GDPR. Our legitimate interest lies in analyzing and optimizing our website to provide a better experience for our users.

For more information on data processing by Plausible Analytics, please visit: https://plausible.io/data-policy
