...
---
## WHOAMI
I am a Software Developer with experience of half a decade. The whole **Typescript** ecosystem is my home turf, where I love to build applications with plain **Node.js** or **Nest.js**.
Furthermore, I also build backend applications with **Java** and **Spring Boot**. 
